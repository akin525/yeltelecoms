                        ...
                        <div class="row p-b-30">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="name" placeholder="Full Name" aria-label="Full Nmae" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success text-white" id="basic-addon1"><i class="ti-mobile"></i></span>
                                    </div>
                                    <input type="number" class="form-control form-control-lg" name="number" placeholder="Phone No" aria-label="Phone No" aria-describedby="basic-addon1" required>
                                </div>
                                <!-- email -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="row border-top border-secondary">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-block btn-lg btn-success" type="submit">Sign Up</button>

                                        <button class="btn btn-block btn-lg btn-info" type="button" onclick="window.location='{{route('login')}}'">login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
