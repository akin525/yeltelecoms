...
<head>
    ...
    <!-- Meta -->
    <meta name="description" content="Global Mobile Data | Buy data in a few clicks to keep surfing the internet. You can buy whatever size of data plan for whichever network you desire. All plans are topped-up to your specified number in seconds.">
    ...
    <nav class="sidebar-wrapper">
        ...
        <div class="sidebar-tabs">
            ...
            <div class="nav" role="tablist" aria-orientation="vertical">
                <a href="#" class="logo">
                    <img src="{{asset('img/5.jpg')}}" alt="Global">
                </a>
                ...
                <div class="tab-pane fade" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="sidebarMenuScroll">
                        <div class="sidebar-menu">
                            ...
                            <ul>
                                <li class="list-heading">Bills</li>
                                <li>
                                    <a href="#">Buy Data</a>
                                </li>
                                <li>
                    ...
                    <div class="sidebar-actions">
                        ...
                        <a href="invoices-list.html" class="green">
    ...
    <div class="main-container">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end md" aria-labelledby="userSettings">
                                <div class="header-profile-actions">
                                    ...
                                    <a href="#"><i class="icon-log-out1"></i>Logout</a>
                                </div>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="content-wrapper-scroll">
            ...
            <div class="content-wrapper">
                ...
                <!-- App footer start -->
                <div class="app-footer">© Global Mobile Data 2022</div>
                <!-- App footer end -->
